...
<div id="wrap"><!-- InstanceBeginEditable name="Content" -->
              ...
              <table width="680" border="0" cellpadding="20" cellspacing="0">
                <tr>
                  <td align="left"><span class="plaintext"><a href="../index.html">Club Penguin Help</a> &gt; Technical Question </span>                    <h1>Technical Question</h1>
                      ...
                      <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="form">
                          ...
                          <input type='hidden' name='rnd' value='6003470' />
                          ...
                          <input name="Action" type="hidden" id="Action" value="Process">
                            ...
                            <tr>
                              <td colspan="3" class="plaintext">Please provide a detailed message as to the problem. Include any error messages. </td>
                            </tr>
